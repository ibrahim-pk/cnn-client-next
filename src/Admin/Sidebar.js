  ...
  return (
    <aside className="bg-gray-900 text-white w-64 min-h-screen h-auto pl-4 pr-4 z-40">
      <div className="flex items-center fixed pt-4 left-5 bg-gray-900 z-20">
        <Link href="/">
          <img src="/images/header/bartaloy24.png" className="h-12 w-12" alt="" />
        </Link>
        <br></br>
      ...
      <nav className="pt-5">
        <ul>
          ...
          <li className="mb-8 ">
            <div
              onClick={() => {
                ...
                // handleMenuItemClick("News Management");
              }}
            ...
            {newsMenuOpen && (
              <ul className="ml-4">
                <li className="mt-2 hover:bg-gray-500 p-1 transition duration-300 ease-in-out">
                  <Link
                    href="/admin/news-management/create"
                ...
                <li className="mt-2 hover:bg-gray-500 p-1 transition duration-300 ease-in-out">
                  <Link
                    href="/admin/news-management/manage-tag"
                    className="text-gray-400 hover:text-gray-100 transition">
                    Manage Tags
                  </Link>
                </li>
                <li className="mt-2 hover:bg-gray-500 p-1 transition duration-300 ease-in-out">
                  <Link
                    href="/admin/news-management/video-link"
                    className="text-gray-400 hover:text-gray-100 transition">
                    Video Link
                  </Link>
                </li>
          ...
          <li className="mb-3 hover:bg-gray-500 p-1 transition duration-300 ease-in-out hover:text-white">
            <Link href="/admin/help" className="  flex text-center transition">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
