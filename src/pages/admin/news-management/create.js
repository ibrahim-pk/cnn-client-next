...
import Editor from "@/Admin/Components/TextEditor/TextEditorWithQuill";
...
function CreateNews() {
 ...
 if (typeof window !== "undefined") {
  const user = JSON.parse(localStorage.getItem("cnnUser"));
  userBio=user?.bio;
  userId=user?._id;
}
  ...
  const handleSubmit = async (e) => {
    ...
    newsData.append("bio", userBio);
    newsData.append("repoter",userId);
