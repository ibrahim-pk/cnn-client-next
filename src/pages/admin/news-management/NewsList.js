...
import NewsTable from "@/Admin/Components/NewsListComponents/NewsTable";
import Pagination from "@/Search/SearchPagination";
...
function NewsList() {
  ...
  return (
    <div className="App mt-12 mx-4">
      <h1 className="text-3xl font-bold mb-4">bartaloy24 News</h1>
      <NewsTable
        data={newsData}
