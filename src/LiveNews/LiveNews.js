...
//         `https://api.bartaloy24.com/api/getNewsByLiveUpdateType/${liveUpdateType}`
//       );
...
//       const response = await axios.get(
//         `https://api.bartaloy24.com/api/getOldestNewsArticleByType/${liveUpdateType}`
//       );
...
//                 By <span>{firstNews?.authorName}</span>, Bartaloy24
//               </div>
//               <div className=" text-gray-400 mt-2">
//                 {" "}
...
//             </div>
//           </div>
//           <div className="mt-16 mx-12 flex w-full ">
//             <div className="w-4/12 p-6 m-5 border-b border-t-4 border-t-red-600 border-l border-r rounded hidden md:block">
...
//             <div className="w-full mr-8 md:w-8/12 ">
